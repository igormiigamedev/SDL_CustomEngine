...
class Play : public GameState{
	...
	private:
		...
		template<typename T>
		void SpawnObjectsOnFloors(GameObjectType objectType, int firstAvailableFloor, std::shared_ptr<TileMap>& map, int objectsPerFloor, int verticalOffsetMultiplier = 4);
